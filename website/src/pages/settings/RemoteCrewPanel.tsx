  ...
  return (
    ...
    {editing && (
      <EditInstanceForm
        ...
        // Both a known cloud crew and one we cannot rule out are matched to their
        // AWS resources through the SSM target; editing that away would strand a
        // billing machine the dashboard could no longer stop or delete.
        lockTransport={isCloud || unverifiedCloud}
      />
    )}
    </div>
  )
